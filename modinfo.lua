meta =
{
    ...
    name = "BrimmsTradeHelper",

    -- Title of your mod that will be displayed to players
    title = "Brimm's Trade Helper",

    -- Description of your mod that will be displayed to players
    description = "This mod fixes a few UI elements to make trading easier and more enjoyable.",
